...
set SIM_ROOT  "$PROJ_ROOT/sim/wck_dq_align"
set XILINX_SIMLIB "E:/xilinx_simlib"

cd $SIM_ROOT
transcript file "$SIM_ROOT/wck_dq_align_transcript.log"
...
vlog -sv -work work "$SIM_ROOT/tb_wck_dq_align.v"
vlog -work work "E:/AMD/Vivado/2022.2/data/verilog/src/glbl.v"
vsim -t ps -L unisims_ver -L unisim -L xpm -L secureip work.tb_wck_dq_align work.glbl
run -all
quit -f
